...
MAIL_PORT=587
MAIL_USERNAME=tax_solutions_group
MAIL_PASSWORD=Flash007
MAIL_ENCRYPTION=tls
...
//echo '../../../vendor/autoload.php';exit;
function helloEmail()
{

    $from = new Email(null, "rahul.baweja@visions.net.in");
    $subject = "SendGrid Email From API PHP";
    $to = new Email(null, "vasik@visions.net.in");
    $content = new Content("text/plain", "Hello This is a test Message");
    $mail = new Mail($from, $subject, $to, $content);
    $to = new Email(null, "rahul.baweja@visions.net.in");
...
{
    $from = new Email("DX", "vasik@visions.net.in");
    $subject = "Hello World from the SendGrid PHP Library2222";
    $to = new Email("Example User", "rahul.baweja@visions.net.in");
    ...
    $reply_to = new ReplyTo("rahul.baweja@visions.net.in", "Optional Name");
...
{
    //$apiKey = getenv('xV1jHGPzTaijTjua3IVZVQ');
    $apiKey = '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';
