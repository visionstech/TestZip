<!--https://www.hometaxsavings.com/prelive/project/resources/assets/customer/css/images/logoblue.jpg-->
<table cellpadding="0" cellspacing="0" style="width:100%; margin:0 auto;font-weight: normal;font-family: Arial, sans-serif;color:#000000;border:0;line-height: 1.2;font-size: 11pt;max-width: 650px;">
  <tbody>
    <tr>
    <?php //echo "<pre>eeeee";print_r($topComparableData['subject']->subjectOtherData->appeal_year);exit;?>
      
      <td>
        <table cellspacing="0" cellpadding="0" style="width: 100%;font-size: 12pt;">
        <tr>
          <td style="font-weight: bold;text-align: center;padding-bottom: 10px;font-size: 10pt;">
      ...
      <td>
        <table cellspacing="0" cellpadding="0" style="width: 100%;font-size: 12pt;">
          ...
          <!--tr>
            ...
            <td style="width: 5%;padding-bottom: 14px;">
              <b style="width: 14px;height: 14px;border:1px solid #000;display: inline-block;"></b>
            </td>
            <td style="padding-bottom: 14px;">
              Select Written, Telephone or In-Person hearing
            </td>
          </tr>
          <tr>
            <td style="width: 5%;padding-bottom: 14px;">
          ...
          <tr>
            ...
            <td style="padding-bottom: 14px;">
              Be on the lookout for correspondence from Washington, DC regarding your appeal
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
        <td>
            <table cellpadding="20" cellspacing="0" style="width: 100%; font-size: 12pt;border: 1px solid #000;padding-bottom: 30px;">  
        <tr>
                ...
                <table cellpadding="2" cellspacing="0" style="width: 100%; font-size: 9pt;font-weight: bold;">
                    <tr>
                        <td style="width: 40%;color: #ff0000; border-left: 1px solid #000; border-bottom: 1px solid #000;"> 
                             {{ $topComparableData['subject']->subjectOtherData->appeal_year }} TOTAL VALUE: $ {{ $total_assessment_value }}
                        </td>
                        <td style="width: 60%;color: #ff0000;border-left: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000;">
                            REQUESTED  {{ $topComparableData['subject']->subjectOtherData->appeal_year }} TOTAL VALUE: $ {{ $final_Value }}   
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                      <td>
                        <table cellspacing="0" cellpadding="0" style="width: 100%;font-size: 7pt;">
                          ...
                          <tr>
                            <td colspan="" style="border-bottom: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;padding-left: 2px;padding-top: 2px;height: 22.8px;">
                            ...
                            ?>
                            <td style="border-bottom: 1px solid #000;border-right: 1px solid #000;padding-left: 2px;">
                         ...
                         <!--  <tr>
                          ...
                          <tr>
                            <td style="width: 50%;border-bottom: 1px solid #000;border-left: 1px solid #000;padding-left: 2px;padding-top: 2px;height: 25px;">
                               Exterior
                            </td>
                            <td style="width: 50%;border-bottom: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;padding-left: 2px;padding-top: 2px;">
                            ...
                            <td>
                               ...
                               <!--  <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="border-bottom: 1px solid #000;padding-left: 2px;padding-top: 2px;height: 25px;">
                                    ...
                                    <td style="color: #ff0000;border-left: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000;padding-left: 2px;padding-top: 2px;">
                                          <table cellspacing="0" cellpadding="0" style="width: 100%;">
                                            <tr>
                                              ...
                                              <td style="width: 90%;text-align: right;padding-right: 5px;">
                                                {{ ($compDetails->com_details['garage'] !='' && $compDetails->com_details['garage'] != '-')?(money_format('%!n', $compDetails->com_details['garage'])): (money_format('%!n', 0)) }}
                                              </td>
                                            </tr>
                                          </table>       
                                    </td>
