<table cellpadding="2" cellspacing="0" style="width:100%; margin:0 auto;font-weight: normal;font-family: arial;color:#000000;border:0;line-height: 1.2;font-size: 11pt;">
	<tbody>
			...
			<td>
				<table style="width: 100%;" cellspacing="0">
					<tr> 
						...
						<td style="width: 80%;text-align: center;font-size: 20pt;line-height: 1;vertical-align: top;font-weight: bold;">2016 REAL ESTATE ASSESSMENT APPEAL <br>APPLICATION</td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td>
				<table style="width: 100%;" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td style="width:50%;line-height: 1.2;"><b>Telephone:</b> 703-222-8234; TTY 711<br><b>E-mail:</b> http://iCare.fairfaxcounty.gov/ContactUs/<br><b>Internet:</b> <a style="color: #000;text-decoration: underline;" href="">www.fairfaxcounty.gov/dta</a></td>
						<td style="width:50%; vertical-align: top;">
		...
		<tr><td></td></tr>
		<tr>
			<td style="vertical-align: top;font-weight: bold;font-size: 14pt;font-style: italic;"><b style="display: inline-block;width:29%;border-bottom: 4px dotted #000;height: 8px;"></b>&nbsp; APPEAL DEADLINE IS APRIL 4 &nbsp;<b style="display: inline-block;width:29%;border-bottom: 4px dotted #000;height: 8px;"></b></td>
		</tr>
		<tr>
			<td style="font-style: italic;">Appeals received after the deadline will not be processed until the coming year's assessment review is complete.</td>
		</tr>
		<tr>
			<td style="height: 2px;"></td>
		</tr>
		<tr>
			<td style="border:2px solid #000;">
				<table style="border:1px solid #000;width: 100%;" cellspacing="0">
					 <tr>
					 	<td colspan="2" style="width: 100%;border-bottom: 1px solid #000;">&nbsp;Address of Property Being Appealed:</td>
					 </tr>
					 <tr>
					 	<td style="width: 70%;border-right: 1px solid #000;border-bottom: 1px solid #000;"> &nbsp;Property Location (City):</td>
					 	<td style="width: 30%;border-bottom: 1px solid #000;"> &nbsp;Property Zip Code:</td>
					 </tr>
					 <tr>
					 	<td colspan="2" style="width: 100%;border-bottom: 1px solid #000;"> &nbsp;Building Name (if any):</td>
					 </tr>
					 <tr>
					 	<td colspan="2" style="width: 100%;border-bottom: 1px solid #000;"> &nbsp;Name of owner (s) on Jan. 1, 2016:</td>
					 </tr>
					 <tr>
					 	<td colspan="2">
					 		<table style="width: 100%;" cellpadding="0" cellspacing="0">
					 			<tr>
					 				<td style="width: 30%;"> &nbsp;2016 Assessment Notice Values:</td>
								 	<td style="width: 20%;">Land:</td>
		...
		<tr>
			<td style="width: 100%;font-weight: bold;height: 60px;">Under state law, financial impact and/or the rate of value change <u>is not</u> sufficient grounds for appeal. As required, the county's assessment is an estimate of fair market value as of Jan. 1, 2016. Appeals should be based on at least one of the three categories noted below. Check one or more for your appeal basis.</td>
		</tr>
		<tr>
			<td style="border:2px solid #000;">
				<table style="border:1px solid #000;width: 100%;" cellspacing="0">
					 <tr>
					 	<td style="width: 4%;border-right: 1px solid #000;border-bottom: 1px solid #000;"> &nbsp;<input type="checkbox" ></td>
		...
		<tr>
			<td style="border:2px solid #000;border-bottom: 0;">
				<table style="border:1px solid #000;width: 100%;" cellspacing="0">
					 <tr>
					 	<td style="width: 100%;height: 28px;font-style: italic;">&nbsp;Based on this appeal information, I believe the proper assessment of this property as of Jan. 1, 2016 should be:</td>
					 </tr>
				</table>
			</td>
		</tr>
			...
			<td style="border:2px solid #000;border-bottom: 0;border-top: 0;">
				<table style="border:0px solid #000;width: 100%;" cellspacing="0">
					 <tr>
					 	...
					 	<td style="height: 28px;width: 0.1%;"></td>
					 	<td style="height: 28px;width: 33%;border:1px solid #000;">&nbsp;Total:</td>
					 </tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table style="width: 100%;" cellspacing="0">
					...
					<tr>
						...
						<td style="width: 20%;font-size: 9pt;height: 25px;">Revised 01/2016</td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td>
				<table style="width: 100%;border:1px solid #000;" cellspacing="0">
					...
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Year Built:</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Total number of fireplaces (incl bsmt):</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Year house remodeled & cost:</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Central air conditioning (yes or no):</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Year kitchen remodeled & cost:</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Number of bedrooms in basement:</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Year bath/baths remodeled & cost:</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Number of dens in basement:</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Total number of rooms - condos only (incl bsmt):</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Size of basement rec room (square feet):</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Total number of bedrooms:</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Second kitchen (yes or no):</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Total number of full bathrooms w/tub or shower (incl bsmt):</td>
						<td style="font-size: 10pt;width: 50%;border-bottom:1px solid #000;">&nbsp; Elevator (yes or no):</td>
					</tr>
					<tr>
						<td style="font-size: 10pt;width: 50%;border-right:1px solid #000;border-bottom:1px solid #000;">&nbsp; Total number of half bathrooms (incl bsmt):</td>
					...
					<tr>
						<td colspan="2" style="border-bottom:1px solid #000;">&nbsp; Most recent sale date and price:</i></td>
					</tr>
					<tr>
						<td colspan="2">
							<table style="width: 100%" cellspacing="0">
					...
					<tr>
						<td>
							<table style="width: 100%" cellspacing="0">
								<tr>
									<td style="width: 1%;"></td>
									<td style="width: 99%;">Provide information below relating to properties with characteristics, assessments or sales prices that support your assessment appeal. Sales in 2015 can be considered for the 1/1/16 assessment; sales that occur in 2016 are not applicable until the Jan. 1, 2017 assessment. Assistance information is noted at the bottom of this page.</td>
								</tr>
							</table>
						</td>
					</tr>
