...
<div class="tsg-inner-wrapper"> 
    <div class="tsg-latest add-user-payment-page">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">    
            ...
            <div class="tsg-inner-wrapper"> 
               <!--  {!! Form::open(['url' => 'generate-sheet', 'id' => 'generate-sheet_form', 'novalidate' => 'novalidate']) !!}
                ...
                <a href="{{ url('/download-top-adjusted-comps') }}" class="btn btn-ctrl">Download Top Comparables</a>
		...
		<div>
        <a href="{{ url('/download-all-adjusted-comps') }}" class="btn btn-ctrl">Download all comparables</a>
		</div
