...
<div class="tsg-inner-wrapper"> 
    {!! Form::open(['url' => 'adjustment-test-api-comparables', 'id' => 'test_api_comparables_form', 'novalidate' => 'novalidate']) !!}
    <div class="tsg-latest tsg-common-details add-user-payment-page">
        ...
        <div class="col-xs-12 col-md-7 col-sm-7 col-lg-7">    
            ...
            <div class="form-group has-feedback element">
                <label>Parcel Size Value<span class="required">*</span></label>
                <div class="form-section">
                    {!! Form::text('parcel_size_value', '13454', $attributes = ['id' => 'parcel_size_value','class' => 'form-control', 'placeholder'=>'Parcel Size']) !!}
                </div>
            </div>
        </div>
        </div>
