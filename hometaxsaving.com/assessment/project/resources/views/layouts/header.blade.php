...
<meta charset="UTF-8">
 ...
 error_reporting(1);
      ...
      require_once($server.'/settings1.php');
      // require_once($server.'/wp-settings.php');
        ?>
      ...
      <div class="top-header">
         <div class="container">
            <div class="header-logo">
               <a href="https://www.hometaxsavings.com"><img src="{{ asset('/project/resources/assets/customer/css/images/logoblue.jpg') }}" alt="Home Tax Savings" title="Home Tax Savings"></a>
            </div>
