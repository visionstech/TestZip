        ...
        <div class="tsg-whole-Wrapper">
            ...
            <div class="tsg-top-row-bg">
                <div class="tsg-inner-wrapper">
                    <div class="tsg-steps-row text-center">
                        <ul>
                            <li @if(isset($token_status) && $token_status >= '2') class="view_details_from_token" @endif data-href="{{ url('/make-payment') }}">
                                <span class="num @if(isset($active) && $active == 'make_payment') active @endif">1</span>
                                <h4>Make a Payment</h4>
                            </li>
                            <!--li @if(isset($token_status) && $token_status >= '2') class="view_details_from_token" @endif data-href="{{ url('/address') }}">
                                <span class="num @if(isset($active) && $active == 'enter_address') active @endif">2</span>
                                <h4>Enter Address</h4>
                            </li-->
                            <li @if(isset($token_status) && $token_status >= '2') class="view_details_from_token" @endif data-href="{{ url('/verify-address') }}">
                                <span class="num @if(isset($active) && $active == 'verify_address') active @endif">2</span>
                                <h4>Verify Search</h4>
                            </li>
                            <li @if(isset($token_status) && $token_status >= '3') class="view_details_from_token" @endif data-href="{{ url('/assessment-review') }}">
                                <span class="num @if(isset($active) && $active == 'assessment_review') active @endif">3</span>
							 ...
							 <li @if(isset($token_status) && $token_status >= '4') class="view_details_from_token" @endif data-href="{{ url('/phase2-payment') }}">
                                <span class="num @if(isset($active) && $active == 'assessment_review') active @endif">4</span>
            ...
            <div class="tsg-inner-wrapper"> 
                <div class="form-group pull-right start_session">
                    <a href="{{ url('/start-new-session/1') }}" class="btn btn-success">Start New Search</a>
                </div>
            </div>
            @endif
